...
package de.srendi.advancedperipherals.client.platform;

import com.mojang.blaze3d.vertex.PoseStack;
import de.srendi.advancedperipherals.network.NetworkMessage;
import de.srendi.advancedperipherals.network.ServerNetworkContext;
...
public interface ClientPlatformHelper extends de.srendi.advancedperipherals.impl.client.ClientPlatformHelper {
    static ClientPlatformHelper get() {
        return (ClientPlatformHelper) de.srendi.advancedperipherals.impl.client.ClientPlatformHelper.get();
    }
